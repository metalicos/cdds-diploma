...
import ua.com.cyberdone.devicemicroservice.device.hydroponic.v1.service.DispenserTemplateService;
import ua.com.cyberdone.devicemicroservice.security.JwtService;

import static org.springframework.http.HttpHeaders.AUTHORIZATION;

/**
 * API шаблонів налаштувань дозаторів
 */
@RestController
@RequiredArgsConstructor
@RequestMapping(value = "/device/hydroponic/v1/dispenserTemplates", produces = MediaType.APPLICATION_JSON_VALUE)
public class DispenserTemplateController {
    ...
    @PostMapping
    public ResponseEntity<DispenserTemplateDTO> createDispenserTemplate(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DispenserTemplateDTO> updateDispenserTemplate(@PathVariable Long id,
                                                                        @RequestBody DispenserTemplateDTO dispenserTemplateDTO) {
        return ResponseEntity.ok(dispenserTemplateService.update(id, dispenserTemplateDTO));
    }
