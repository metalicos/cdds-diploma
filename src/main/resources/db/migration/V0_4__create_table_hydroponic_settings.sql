...
(
    ...
    `recheck_ph_dispensers_after_seconds`    BIGINT       NULL DEFAULT NULL,
    `recheck_tds_dispensers_after_seconds`   BIGINT       NULL DEFAULT NULL,
    `calculate_start_solution_as_fertilizer` BIT(1)       NULL DEFAULT NULL,
    `calculate_ph_regulation_as_fertilizer`  BIT(1)       NULL DEFAULT NULL,
