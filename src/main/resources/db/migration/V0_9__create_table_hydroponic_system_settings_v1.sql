...
ALTER TABLE IF EXISTS public."HYDROPONIC_SYSTEM_SETTINGS_V1" OWNER to postgres;

CREATE INDEX IF NOT EXISTS IDX_DEVICE_UUID_HASH_qwej ON public."HYDROPONIC_SYSTEM_SETTINGS_V1" USING hash ("device_uuid");

CREATE INDEX IF NOT EXISTS IDX_SETTING_DETAIL_ID_HASH_drf ON public."HYDROPONIC_SYSTEM_SETTINGS_V1" USING hash ("setting_detail_id");
