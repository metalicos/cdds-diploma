...
ALTER TABLE IF EXISTS public."HYDROPONIC_DISPENSER_SETTINGS_V1" OWNER to postgres;

CREATE INDEX IF NOT EXISTS IDX_DEVICE_UUID_HASH_qweqwrq ON public."HYDROPONIC_DISPENSER_SETTINGS_V1" USING hash ("device_uuid");

CREATE INDEX IF NOT EXISTS IDX_SETTING_DETAIL_ID_HASH_cewrtw ON public."HYDROPONIC_DISPENSER_SETTINGS_V1" USING hash ("setting_detail_id");
