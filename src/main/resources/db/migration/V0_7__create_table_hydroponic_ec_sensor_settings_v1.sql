...
ALTER TABLE IF EXISTS public."HYDROPONIC_EC_SENSOR_SETTINGS_V1" OWNER to postgres;

CREATE INDEX IF NOT EXISTS IDX_DEVICE_UUID_HASH_oiwru ON public."HYDROPONIC_EC_SENSOR_SETTINGS_V1" USING hash ("device_uuid");

CREATE INDEX IF NOT EXISTS IDX_SETTING_DETAIL_ID_HASH_wker ON public."HYDROPONIC_EC_SENSOR_SETTINGS_V1" USING hash ("setting_detail_id");
